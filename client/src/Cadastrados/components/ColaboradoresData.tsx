...
export default function ColaboradoresData({ day, order }: Proped) {
...
<div className="search_container">
    ...
    {data.filter((dat) => dat.nome.includes(input))
        .map(dat => {
            return (
                <tr>
                <td>
                ...
                <td>
                  <button className="more_options" onClick={() => handleDelete(dat.id)}>
                    <svg
                      viewBox="0 0 100 100"
